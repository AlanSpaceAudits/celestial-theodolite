#!/usr/bin/env python3
"""
Celestial Theodolite — Mount Rosa Occlusion EL Statistics
==========================================================

This script analyzes the elevation angle (EL) of stars at the moment they are
occluded by Mount Rosa. Two geometric predictions are calculated from the
