#!/usr/bin/env python3
"""
Celestial Theodolite — Cheyenne Mountain Occlusion EL Statistics
=================================================================

This script analyzes the elevation angle (EL) of stars at the moment they are
occluded by Cheyenne Mountain. Two geometric predictions are calculated from the
