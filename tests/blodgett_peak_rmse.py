#!/usr/bin/env python3
"""
Celestial Theodolite — Blodgett Peak RMSE Analysis
====================================================
...
if __name__ == "__main__":
    ...
    #   - Error bars = ±2σ (internal spread of observations)
    #   - Annotations for the delta and RMSE
    ...
    if SHOW_GRAPH:
        ...
        plt.savefig("blodgett_peak_rmse.png", dpi=150, bbox_inches="tight")
        print(f"\n  Graph saved: blodgett_peak_rmse.png")
        plt.show()
