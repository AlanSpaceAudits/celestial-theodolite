#!/usr/bin/env python3
"""
Celestial Theodolite — Cheyenne Mountain RMSE Analysis
=======================================================
...
PEAK_NAME = "Cheyenne Mountain"  # name of the peak (used in output labels)
OBSERVER  = "Dr. Heffron"        # observer who recorded the data

h_peak    = 2883                 # peak elevation above sea level (meters)
h_obs     = 2073                 # observer elevation above sea level (meters)
d         = 42551                # observer-to-peak distance (meters)
...
# - time:       local time of the observed occlusion (UTC-6)
...
observations = [
    (26, "03/09/25", "20:01:14", "Mu Fornacis",  93.816234,  93.450686),
    (27, "03/09/25", "20:28:42", "HD 16733",    100.701700, 100.336152),
    (28, "03/09/25", "20:39:43", "HD 17926",    103.463407, 103.097859),
    (29, "03/09/25", "21:22:11", "HD 22248",    114.109140, 113.743592),
    (30, "03/09/25", "21:38:29", "HD 24267",    118.195297, 117.829749),
    (31, "03/09/25", "21:49:34", "HD 25371",    120.973716, 120.608168),
]
...
el_fe = [
    1.002037, 0.997083, 0.990820, 1.017372, 1.010417, 1.005112,
]

# GE (green sheet) — observed EL using globe earth geometry
el_ge = [
    0.619372, 0.614422, 0.608152, 0.634710, 0.627752, 0.622459,
]
...
if __name__ == "__main__":
    ...
    if SHOW_GRAPH:
        ...
        plt.savefig("cheyenne_mtn_rmse.png", dpi=150, bbox_inches="tight")
        print(f"\n  Graph saved: cheyenne_mtn_rmse.png")
        plt.show()
