#!/usr/bin/env python3
"""
Celestial Theodolite — Mount Rosa RMSE Analysis
=================================================
...
the PREDICTED value, so a model that consistently misses gets penalized.
...
PEAK_NAME = "Mount Rosa"         # name of the peak (used in output labels)
OBSERVER  = "Dr. Heffron"        # observer who recorded the data

h_peak    = 3506                 # peak elevation above sea level (meters)
h_obs     = 2073                 # observer elevation above sea level (meters)
d         = 47628                # observer-to-peak distance (meters)
...
observations = [
    (32, "03/10/25", "20:51:26", "HD 17320"),
    (33, "03/10/25", "21:00:52", "HD 18290"),
]
...
if __name__ == "__main__":
    ...
    if SHOW_GRAPH:
        ...
        # At small angles: Δh ≈ d × tan(σ_radians)
        ...
        # Bar: observed mean (darker green), with ±1σ error bars
        ...
        # Bar: observed mean (magenta), with ±1σ error bars
        ...
        plt.savefig("mount_rosa_rmse.png", dpi=150, bbox_inches="tight")
        print(f"\n  Graph saved: mount_rosa_rmse.png")
        plt.show()
